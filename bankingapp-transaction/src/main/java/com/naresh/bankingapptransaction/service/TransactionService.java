...
public class TransactionService {
	...
	public List<String> list(Integer accountId){
		System.out.println("Actual Method - list transactions for the given account Id");
    ...
    public List<String> defaultTransactions(Integer accountId) {
    	System.out.println("Fallback Method - list transactions for the given account Id");
